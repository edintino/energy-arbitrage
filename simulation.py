...
import numpy as np
import pandas as pd
from config import START_DATE, END_DATE, DATA_PATH, COUNTRIES, TARGET_RMSE, BIAS_FRACTION, NUM_SCENARIOS
...
def simulate_forecast():
    ...
    scenarios = np.random.normal(base, sigma_noise, (T, M, NUM_SCENARIOS))
